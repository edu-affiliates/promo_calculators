...
class CFSearch extends React.Component {
    ...
    render() {
        return (
            <div className="cf-search-wrap">
                <input className="cf-search" value={this.state.searchString}
...
export default connect(mapStateToProps, mapDispatchToProps)(CFSearch);
